...
Процедура ТестДолжен_НайтиНесколькоСтрокВТаблице() Экспорт
	...
	// КлючиПоиска = Новый Структура("Ключ,Значение", "Истина", Истина); не работает пока такой конструктор...
	КлючиПоиска = Новый Структура;
	КлючиПоиска.Вставить("Ключ", "Истина");
	КлючиПоиска.Вставить("Значение", Истина);
