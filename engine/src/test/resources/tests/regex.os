...
//	ВсеТесты.Добавить("ТестДолжен_ПроверитьПолучениеИменованныхГруппБезИменования"); // TODO
//	ВсеТесты.Добавить("ТестДолжен_ПроверитьПолучениеИменованныхГруппСИменованиемИСмешаннымПорядком"); // TODO
...
Процедура ТестДолжен_СоздатьОбъектРегулярноеВыражение() Экспорт
	...
	// Проверим доступ по имени
	юТест.ПроверитьРавенство(РегулярноеВыражение.Многострочный, Истина);
	юТест.ПроверитьРавенство(РегулярноеВыражение["Многострочный"], Истина);

	РегулярноеВыражение["Многострочный"] = Ложь;
	юТест.ПроверитьРавенство(РегулярноеВыражение["Многострочный"], Ложь);
...
Процедура ТестДолжен_ПроверитьПолучениеВложенныхГрупп() Экспорт
	...
	юТест.ПроверитьРавенство(ИсходнаяСтрока, Группа0.Значение, "Группа0.Значение");
    юТест.ПроверитьРавенство(3, Группа0.Длина, "Группа0.Длина");
    //юТест.ПроверитьРавенство(0, Группа0.Индекс, "Группа0.Индекс");
