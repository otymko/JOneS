...
Процедура ТестДолжен_ПоведениеИндексовПриУдаленииКолонок()
...
Процедура ТестДолжен_ПоведениеИндексовПриИзмененииЗначенийИндексированныхПолей()
...
Процедура ТестДолжен_ПроверитьВыбросИсключений()
