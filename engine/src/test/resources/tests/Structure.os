...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьКонструкторСПустымиКлючами");
...
Процедура ТестДолжен_ПроверитьКонструкторСПустымиКлючами() Экспорт
    Структура = Новый Структура(, Неопределено, Неопределено);
    юТест.ПроверитьРавенство(0, Структура.Количество());
КонецПроцедуры;