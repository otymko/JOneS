...
Процедура ТестДолжен_ПроверитьУдаление() Экспорт
	...
	Соответствие.Вставить("123", 1);
	КоличествоДо = Соответствие.Количество();
	Соответствие.Очистить();

	юТест.ПроверитьРавенство(КоличествоДо, 1);
	юТест.ПроверитьРавенство(Соответствие.Количество(),  0);
