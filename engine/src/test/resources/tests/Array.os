...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
    ...
    ВсеТесты.Добавить("ТестДолжен_ПроверитьКонструкторы");
...
Процедура ТестДолжен_ПроверитьКонструкторы()
    Массив = Новый Массив()
    юТест.ПроверитьИстину(Массив.Количество() = 0)

    МассивСЧемТо = Новый Массив();
    МассивСЧемТо.Добавить(Истина);
    Массив = Новый Массив(Новый ФиксированныйМассив(МассивСЧемТо));
    юТест.ПроверитьИстину(Массив.Количество() = 1)

    Массив = Новый Массив(1);
    юТест.ПроверитьИстину(Массив.Количество() = 1)

    Массив = Новый Массив(1, 2);
    юТест.ПроверитьИстину(Массив.Количество() = 2)
КонецПроцедуры